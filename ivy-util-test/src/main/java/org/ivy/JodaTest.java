...
public class JodaTest {
    ...
    public static void main(String[] args) {
        Date date0 = new Date();
        DateTime dt = new DateTime(date0.getTime());
        ...
        String dateTimeStr1 = dateTime2.toString("yyyy/MM/dd HH:mm:ss EE");
        System.out.println(dateTimeStr1);

        // 格式化带Locale，输出==> 2012年12月21日 23:22:45 星期五
        String dateTimeStr2 = dateTime2.toString("yyyy年MM月dd日 HH:mm:ss EE", Locale.CHINESE);
        ...
        // DateTime与java.DateTimeUtil对象,当前系统TimeMillis转换
